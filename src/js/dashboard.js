...
//IoT examples 
const iotDevices = [
    { id: "DEV001", name: "Tenperatura Sentsorea A1", status: "online", location: "Eraikina A - 1. Solairua", lastSeen: "2 minutu lehenago" },
    { id: "DEV002", name: "Hezetasun Neurgailua B2", status: "online", location: "Eraikina B - 2. Solairua", lastSeen: "1 minutu lehenago" },
    { id: "DEV003", name: "Presio Neurgailua C1", status: "offline", location: "Eraikina C - 1. Solairua", lastSeen: "15 minutu lehenago" },
    { id: "DEV004", name: "Mugimendu Detektagailua A3", status: "online", location: "Eraikina A - 3. Solairua", lastSeen: "30 segundo lehenago" },
    { id: "DEV005", name: "Aire Kalitate Neurgailua B1", status: "online", location: "Eraikina B - 1. Solairua", lastSeen: "45 segundo lehenago" },
    { id: "DEV006", name: "Argi Sentsorea C2", status: "offline", location: "Eraikina C - 2. Solairua", lastSeen: "8 minutu lehenago" },
    { id: "DEV007", name: "Tremendu Sentsorea A2", status: "online", location: "Eraikina A - 2. Solairua", lastSeen: "1 minutu lehenago" },
    { id: "DEV008", name: "Gas Detektagailua B3", status: "online", location: "Eraikina B - 3. Solairua", lastSeen: "3 minutu lehenago" },
    { id: "DEV009", name: "Ur Maila Neurgailua C3", status: "offline", location: "Eraikina C - 3. Solairua", lastSeen: "22 minutu lehenago" },
    { id: "DEV010", name: "Energia Neurgailua A4", status: "online", location: "Eraikina A - 4. Solairua", lastSeen: "2 minutu lehenago" },
];

//Alert examples
const alertsData = [
    { id: "ALT001", timestamp: "2024-01-15 14:32:15", severity: "critical", message: "Tenperatura sentsorea DEV001 threshold-etik gora (35°C)", device: "DEV001" },
    { id: "ALT002", timestamp: "2024-01-15 14:28:42", severity: "warning", message: "DEV003 gailuaren konexioa moztuta detektatua", device: "DEV003" },
    { id: "ALT003", timestamp: "2024-01-15 14:15:33", severity: "info", message: "DEV007-rentzat programatutako mantenua burutua", device: "DEV007" },
    { id: "ALT004", timestamp: "2024-01-15 13:45:21", severity: "critical", message: "Gas ihes bat detektatua DEV008 sentsoreak", device: "DEV008" },
    { id: "ALT005", timestamp: "2024-01-15 13:22:18", severity: "warning", message: "DEV006 gailuarentzako bateria baxuaren alerta", device: "DEV006" },
    { id: "ALT006", timestamp: "2024-01-15 12:58:45", severity: "info", message: "DEV004 gailuaren firmwarea arrakastaz eguneratua", device: "DEV004" },
    { id: "ALT007", timestamp: "2024-01-15 12:33:12", severity: "warning", message: "Hezetasun mailak ohikoak baino altuagoak B eraikinean", device: "DEV002" },
    { id: "ALT008", timestamp: "2024-01-15 11:47:39", severity: "critical", message: "Ura maila kritiko baxua C3 edukiontziaren barruan", device: "DEV009" },
];
...
function renderDevices(devices) {
  ...
  `;
    ...
    devices.forEach(device => {
        const badgeColor = device.status === 'online'
            ...
            <div class="flex gap-3 items-start">
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-1">
                        <span class="flex items-center gap-1 text-xs font-bold px-2 py-0.5 rounded-full  ${badgeColors[alert.severity]}">
                            ${alert.severity}
                        </span>
                        <span class="text-xs text-black dark:text-white">${alert.device}</span>
                    </div>
                    <p class="text-sm text-black dark:text-white">${alert.message}</p>
                    <p class="text-xs text-black dark:text-white">${alert.timestamp}</p>
                </div>
            </div>
        </div>
        `;
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('search-input').addEventListener('input', applyDeviceFilter);
    document.getElementById('status-filter').addEventListener('change', applyDeviceFilter);
